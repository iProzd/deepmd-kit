...
"""Unit tests for DPA3 V3 (dpa3s_v3_attn) descriptor."""
...
from deepmd.pt.model.descriptor.dpa3s_v3_attn import (
    DescrptDPA3V3,
)
...
class TestDescrptDPA3V3(unittest.TestCase, TestCaseSingleFrameWithNlist):
    def setUp(self) -> None:
    ...
    def test_forward_and_serialize(self) -> None:
        ...
        dd1 = DescrptDPA3V3.deserialize(dd0.serialize())

...
"""Unit tests for DPA3 V1 (dpa3s_v1_rbf) descriptor."""
...
from deepmd.pt.model.descriptor.dpa3s_v1_rbf import (
    DescrptDPA3V1,
)
...
class TestDescrptDPA3V1(unittest.TestCase, TestCaseSingleFrameWithNlist):
    def setUp(self) -> None:
    ...
    def test_forward_and_serialize(self) -> None:
        ...
        dd1 = DescrptDPA3V1.deserialize(dd0.serialize())

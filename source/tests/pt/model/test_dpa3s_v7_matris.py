...
"""Unit tests for DPA3S V7 (dpa3s_v7_matris) descriptor."""
...
from deepmd.pt.model.descriptor.dpa3s_v7_matris import (
    DescrptDPA3V7,
)
...
class TestDescrptDPA3V7(unittest.TestCase, TestCaseSingleFrameWithNlist):
    def setUp(self) -> None:
    ...
    def test_forward_and_serialize(self) -> None:
        ...
        dd1 = DescrptDPA3V7.deserialize(dd0.serialize())

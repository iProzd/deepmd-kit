...
"""Unit tests for DPA3S V5 (dpa3s_v5_gated) descriptor."""
...
from deepmd.pt.model.descriptor.dpa3s_v5_gated import (
    DescrptDPA3V5,
)
...
class TestDescrptDPA3V5(unittest.TestCase, TestCaseSingleFrameWithNlist):
    def setUp(self) -> None:
    ...
    def test_forward_and_serialize(self) -> None:
        ...
        dd1 = DescrptDPA3V5.deserialize(dd0.serialize())

...
"""Unit tests for DPA3S V4 (dpa3s_v4_bessel) descriptor."""
...
from deepmd.pt.model.descriptor.dpa3s_v4_bessel import (
    DescrptDPA3V4,
)
...
class TestDescrptDPA3V4(unittest.TestCase, TestCaseSingleFrameWithNlist):
    def setUp(self) -> None:
    ...
    def test_forward_and_serialize(self) -> None:
        ...
        dd1 = DescrptDPA3V4.deserialize(dd0.serialize())

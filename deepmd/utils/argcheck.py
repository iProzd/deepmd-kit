...
@descrpt_args_plugin.register("dpa3s_v1_rbf", doc=doc_only_pt_supported)
def descrpt_dpa3s_v1_rbf_args() -> list[Argument]:
    doc_n_dim = "The dimension of node representation."
    doc_e_dim = "The dimension of edge representation."
    doc_a_dim = "The dimension of angle representation."
    doc_nlayers = "The number of repflow layers."
    ...
    doc_num_edge_basis = "Number of Gaussian RBF basis functions for edge distance embedding."
    doc_num_angle_basis = "Number of Chebyshev polynomial basis functions for angle (cos theta) embedding."
    doc_concat_output_tebd = (
        "Whether to concat type embedding at the output of the descriptor."
    )
    doc_add_chg_spin_ebd = (
...
@descrpt_args_plugin.register("dpa3s_v2_rbf_norm", doc=doc_only_pt_supported)
def descrpt_dpa3s_v2_rbf_norm_args() -> list[Argument]:
    doc_n_dim = "The dimension of node representation."
    doc_e_dim = "The dimension of edge representation."
    doc_a_dim = "The dimension of angle representation."
    doc_nlayers = "The number of repflow layers."
...
@descrpt_args_plugin.register("dpa3s_v3_attn", doc=doc_only_pt_supported)
def descrpt_dpa3s_v3_attn_args() -> list[Argument]:
    doc_n_dim = "The dimension of node representation."
    doc_e_dim = "The dimension of edge representation."
    doc_a_dim = "The dimension of angle representation."
    doc_nlayers = "The number of repflow layers."
    ...
    doc_num_edge_basis = "Number of Gaussian RBF basis functions for edge distance embedding."
    doc_num_angle_basis = "Number of Chebyshev polynomial basis functions for angle (cos theta) embedding."
    doc_ffn_hidden_mult = "Hidden dimension multiplier for SwiGLU FFN: hidden_dim = int(n_dim * ffn_hidden_mult)."
    doc_concat_output_tebd = (
        "Whether to concat type embedding at the output of the descriptor."
    )
    doc_add_chg_spin_ebd = (
